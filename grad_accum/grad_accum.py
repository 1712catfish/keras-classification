...
def solve_batch_configuration(
        strategy, n_train_samples, n_val_samples,
...
def train(
        ...
        batch_size_per_replica=16, batches_per_update=8
):
    batch_configuration = solve_batch_configuration(
        strategy, n_train_samples, n_val_samples,
        batch_size_per_replica,
        batches_per_update
    )

    for k, v in batch_configuration.items():
        globals()[k] = v
        print("{}: {}".format(k, v))
